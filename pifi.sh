...
rc_file_name=".PiFirc"
alternative_rc_file_name="PiFirc"
...
github_user="PenielMelaku"
github_repository="PiFi"
branch="master"
script_filename="pi-fi.sh"
...
urlmerchandising_shop="https://PiFi.creator-spring.com/"
mail="Penielmelaku10@gmail.com"
author="@PenielMelaku"
...
function language_strings_handling_messages() {
	...
	language_strings_try_to_download["ENGLISH"]="PiFi will try to download the language strings file..."
	language_strings_try_to_download["SPANISH"]="PiFi intentará descargar el fichero de traducciones..."
	language_strings_try_to_download["FRENCH"]="PiFi va essayer de télécharger les fichiers de traductions..."
	language_strings_try_to_download["CATALAN"]="PiFi intentarà descarregar el fitxer de traduccions..."
	language_strings_try_to_download["PORTUGUESE"]="O PiFi tentará baixar o arquivo de tradução..."
	language_strings_try_to_download["RUSSIAN"]="PiFiPiFi попытается загрузить языковой файл..."
	language_strings_try_to_download["GREEK"]="Το PiFi θα προσπαθήσει να κατεβάσει το αρχείο γλωσσών..."
	language_strings_try_to_download["ITALIAN"]="PiFiPiFi cercherá di scaricare il file delle traduzioni..."
	language_strings_try_to_download["POLISH"]="PiFi spróbuje pobrać plik tłumaczeń..."
	language_strings_try_to_download["GERMAN"]="PiFi wird versuchen, die Übersetzungsdatei herunterzuladen..."
	language_strings_try_to_download["TURKISH"]="PiFi çeviri dosyasını indirmeye çalışacak..."
	language_strings_try_to_download["ARABIC"]="سيحاول PiFi تنزيل ملف سلاسل اللغة ..."
	language_strings_try_to_download["CHINESE"]="PiFi 将尝试下载语言支持文件..."
	...
	language_strings_first_time["ENGLISH"]="If you are seeing this message after an automatic update, don't be scared! It's probably because PiFi has different file structure since version 6.1. It will be automatically fixed"
	language_strings_first_time["SPANISH"]="Si estás viendo este mensaje tras una actualización automática, ¡no te asustes! probablemente es porque a partir de la versión 6.1 la estructura de ficheros de PiFi ha cambiado. Se reparará automáticamente"
	language_strings_first_time["FRENCH"]="Si vous voyez ce message après une mise à jour automatique ne vous inquiétez pas! A partir de la version 6.1 la structure de fichier d'PiFi a changé. L'ajustement se fera automatiquement"
	language_strings_first_time["CATALAN"]="Si estàs veient aquest missatge després d'una actualització automàtica, no t'espantis! probablement és perquè a partir de la versió 6.1 l'estructura de fitxers de PiFi ha canviat. Es repararà automàticament"
	language_strings_first_time["PORTUGUESE"]="Se você está vendo esta mensagem depois de uma atualização automática, não tenha medo! A partir da versão 6.1 da estrutura de arquivos do PiFi mudou. Isso será corrigido automaticamente"
	language_strings_first_time["RUSSIAN"]="Если вы видите это сообщение после автоматического обновления, не переживайте! Вероятно, это объясняется тем, что, начиная с версии 6.1, PiFi имеет другую структуру файлов. Проблема будет разрешена автоматически"
	language_strings_first_time["GREEK"]="Εάν βλέπετε αυτό το μήνυμα μετά από κάποια αυτόματη ενημέρωση, μην τρομάξετε! Πιθανόν είναι λόγω της διαφορετικής δομής του PiFi μετά από την έκδοση 6.1. Θα επιδιορθωθεί αυτόματα"
	language_strings_first_time["ITALIAN"]="Se stai vedendo questo messaggio dopo un aggiornamento automatico, niente panico! probabilmente è perché a partire dalla versione 6.1 é cambiata la struttura dei file di PiFi. Sarà riparato automaticamente"
	language_strings_first_time["POLISH"]="Jeśli widzisz tę wiadomość po automatycznej aktualizacji, nie obawiaj się! To prawdopodobnie dlatego, że w wersji 6.1 zmieniła się struktura plików PiFiPiFi. Naprawi się automatycznie"
	language_strings_first_time["GERMAN"]="Wenn Sie diese Nachricht nach einem automatischen Update sehen, haben Sie keine Angst! Das liegt vermutlich daran, dass ab Version 6.1 die Dateistruktur von PiFi geändert wurde. Es wird automatisch repariert"
	language_strings_first_time["TURKISH"]="Otomatik bir güncellemeden sonra bu mesajı görüyorsanız, korkmayın! muhtemelen 6.1 sürümünden itibaren PiFi dosya yapısı değişmiştir. Otomatik olarak tamir edilecektir"
	language_strings_first_time["ARABIC"]="إذا كنت ترى هذه الرسالة بعد التحديث التلقائي ، فلا تخف! ربما يرجع السبب في ذلك إلى أن PiFiPiFi له بنية ملفات مختلفة منذ الإصدار 6.1. سيتم إصلاحه تلقائيًا "
	language_strings_first_time["CHINESE"]="如果您在自动更新后看到此消息，请不要害怕！这可能是因为 PiFi 从 6.1 版本开始有不同的文件结构。会自动修复"

	declare -gA language_strings_exiting
	language_strings_exiting["ENGLISH"]="Exiting PiFi script v${PiFi_version} - See you soon! :)"
	language_strings_exiting["SPANISH"]="Saliendo de PiFi script v${PiFi_version} - Nos vemos pronto! :)"
	language_strings_exiting["FRENCH"]="Fermeture du script PiFi v${PiFi_version} - A bientôt! :)"
	language_strings_exiting["CATALAN"]="Sortint de PiFi script v${PiFi_version} - Ens veiem aviat! :)"
	language_strings_exiting["PORTUGUESE"]="Saindo do script PiFi v${PiFi_version} - Até breve! :)"
	language_strings_exiting["RUSSIAN"]="Выход из скрипта PiFi v${PiFi_version} - До встречи! :)"
	language_strings_exiting["GREEK"]="Κλείσιμο του PiFi v${PiFi_version} - Αντίο :)"
	language_strings_exiting["ITALIAN"]="Uscendo dallo script PiFi v${PiFi_version} - A presto! :)"
	language_strings_exiting["POLISH"]="Wyjście z skryptu PiFi v${PiFi_version} - Do zobaczenia wkrótce! :)"
	language_strings_exiting["GERMAN"]="Sie verlassen PiFi v${PiFi_version} - Bis bald! :)"
	language_strings_exiting["TURKISH"]="PiFi yazılımından çıkış yapılıyor v${PiFi_version} - Yakında görüşürüz! :)"
	language_strings_exiting["ARABIC"]="الخروج من البرنامج PiFi v${PiFi_version}- نراكم قريبًا! :)"
	language_strings_exiting["CHINESE"]="退出 PiFi 脚本 v${PiFi_version} - 待会见！ :)"
...
function option_toggle() {
	...
	case "${option_var_name}" in
		"PiFiPiFi_BASIC_COLORS")
			remap_colors
		;;
		"PiFi_EXTENDED_COLORS")
...
function special_text_missed_optional_tool() {
	...
	if ! "${PiFi_DEVELOPMENT_MODE:-false}"; then
...
function get_5ghz_band_info_from_phy_interface() {
	...
	if iw phy "${1}" channels 2> /dev/null | grep -Ei "5180(\.0)? MHz" > /dev/null; then
		if "${PiFi_5GHZ_ENABLED:-true}"; then
			return 0
		else
			return 2
		fi
	...
	case ${option_selected} in
		...
		2)
			if "${PiFi_AUTO_UPDATE:-true}"; then
				ask_yesno 457 "no"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "PiFi_AUTO_UPDATE"; then
						echo
		...
		;;
		3)
			if "${PiFi_SKIP_INTRO:-true}"; then
				ask_yesno 569 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "PiFi_SKIP_INTRO"; then
						echo
		...
		4)
			if "${PiFi_BASIC_COLORS:-true}"; then
				ask_yesno 558 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "PiFi_BASIC_COLORS"; then
						echo
		...
		5)
			...
			if "${PiFi_EXTENDED_COLORS:-true}"; then
				ask_yesno 462 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "PiFi_EXTENDED_COLORS"; then
						echo
		...
		6)
			if "${PiFi_AUTO_CHANGE_LANGUAGE:-true}"; then
				ask_yesno 469 "no"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "PiFi_AUTO_CHANGE_LANGUAGE"; then
						echo
		...
		7)
			if "${PiFi_SILENT_CHECKS:-true}"; then
				ask_yesno 577 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "PiFi_SILENT_CHECKS"; then
						echo
		...
		8)
			if "${PiFi_PRINT_HINTS:-true}"; then
				ask_yesno 586 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "PiFi_PRINT_HINTS"; then
						echo
		...
		9)
			if "${PiFi_5GHZ_ENABLED:-true}"; then
				ask_yesno 596 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "PiFi_5GHZ_ENABLED"; then
						echo
		...
		10)
			if [ "${PiFi_WINDOWS_HANDLING}" = "xterm" ]; then
				ask_yesno 657 "yes"
				if [ "${yesno}" = "y" ]; then
					sed -ri "s:(PiFi_WINDOWS_HANDLING)=(xterm):\1=tmux:" "${rc_path}" 2> /dev/null
					echo
				...
				ask_yesno 658 "yes"
				if [ "${yesno}" = "y" ]; then
					sed -ri "s:(PiFi_WINDOWS_HANDLING)=(tmux):\1=xterm:" "${rc_path}" 2> /dev/null
					echo
					language_strings "${language}" 620 "yellow"
					language_strings "${language}" 115 "read"
				fi
		...
		12)
			...
			if [ "${yesno}" = "y" ]; then
				if option_toggle "PiFi_PLUGINS_ENABLED" "required_reboot"; then
					echo
					language_strings "${language}" 620 "yellow"
				else
					echo
		...
		13)
			if "${PiFi_FORCE_NETWORK_MANAGER_KILLING:-true}"; then
				ask_yesno 692 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "PiFi_FORCE_NETWORK_MANAGER_KILLING"; then
						echo
			...
			if [ "${yesno}" = "y" ]; then
				...
				if [ "${language}" = "${current_permanent_language}" ]; then
					...
					if "${PiFi_AUTO_CHANGE_LANGUAGE:-true}"; then
						...
						option_toggle "PiFi_AUTO_CHANGE_LANGUAGE"
					fi
...
function decloak_check() {
	...
	if [ "${PiFi_WINDOWS_HANDLING}" = "tmux" ]; then
...
function set_wep_key_script() {
	...
	cat >&8 <<-EOF
		...
		PiFi_WINDOWS_HANDLING="${PiFi_WINDOWS_HANDLING}"
	...
	cat >&6 <<-EOF
		...
		while true; do
			...
			if [ "\${wep_to_be_launched_only_once}" -eq 0 ]; then
				...
				if [ "\${PiFiPiFi_WINDOWS_HANDLING}" = "tmux" ]; then
...
function mdk_version_toggle() {
	...
	if [ "${PiFi_MDK_VERSION}" = "mdk3" ]; then
		sed -ri "s:(PiFi_MDK_VERSION)=(mdk3):\1=mdk4:" "${rc_path}" 2> /dev/null
		PiFi_MDK_VERSION="mdk4"
	else
		sed -ri "s:(PiFi_MDK_VERSION)=(mdk4):\1=mdk3:" "${rc_path}" 2> /dev/null
		PiFi_MDK_VERSION="mdk3"
	fi
...
function print_options() {
	...
	if "${PiFiPiFi_SILENT_CHECKS:-true}"; then
	...
	if "${PiFiPiFi_FORCE_NETWORK_MANAGER_KILLING:-true}"; then
	...
	if [ "${PiFi_WINDOWS_HANDLING}" = "xterm" ]; then
		if grep -q "PiFi_WINDOWS_HANDLING=tmux" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
		language_strings "${language}" 618 "blue"
	else
		if grep -q "PiFi_WINDOWS_HANDLING=xterm" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
	...
	reboot_required_text=""
	if "${PiFi_PLUGINS_ENABLED:-true}"; then
		if grep -q "PiFiPiFi_PLUGINS_ENABLED=false" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
		language_strings "${language}" 653 "blue"
	else
		if grep -q "PiFi_PLUGINS_ENABLED=true" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
...
function clean_env_vars() {
	...
	unset PiFi_AUTO_UPDATE PiFi_SKIP_INTRO PiFi_BASIC_COLORS PiFi_EXTENDED_COLORS PiFi_AUTO_CHANGE_LANGUAGE PiFi_SILENT_CHECKS PiFiPiFi_PRINT_HINTS PiFi_5GHZ_ENABLED PiFi_FORCE_IPTABLES PiFi_FORCE_NETWORK_MANAGER_KILLING PiFi_MDK_VERSION PiFi_PLUGINS_ENABLED PiFi_DEVELOPMENT_MODE PiFi_DEBUG_MODE PiFi_WINDOWS_HANDLING
}
...
function control_routing_status() {
	...
	if [ "${1}" = "start" ]; then
		readarray -t PiFi_PIDS 2> /dev/null < <(cat < "${system_tmpdir}${ag_orchestrator_file}" 2> /dev/null)
		for item in "${PiFi_PIDS[@]}"; do
...
function clean_tmpfiles() {
	...
	if [ "${1}" = "exit_script" ]; then
		...
		if is_last_PiFiPiFi_instance; then
...
function clean_routing_rules() {
	...
	if is_last_PiFi_instance && [[ -n "${system_tmpdir}${routing_tmp_file}" ]]; then
...
function prepare_iptables_nftables() {
	...
	if [ "${iptables_nftables}" -eq 1 ]; then
		"${iptables_cmd}" add table ip filter_"${PiFi_instance_name}"
		"${iptables_cmd}" add chain ip filter_"${PiFi_instance_name}" forward_"${PiFi_instance_name}" '{type filter hook forward priority 0; policy accept;}'
		"${iptables_cmd}" add chain ip filter_"${PiFi_instance_name}" input_"${PiFi_instance_name}" '{type filter hook input priority 0;}'
		"${iptables_cmd}" add table ip nat_"${PiFi_instance_name}"
		"${iptables_cmd}" add chain ip nat_"${PiFi_instance_name}" prerouting_"${PiFi_instance_name}" '{type nat hook prerouting priority -100;}'
		"${iptables_cmd}" add chain ip nat_"${PiFiPiFi_instance_name}" postrouting_"${PiFi_instance_name}" '{type nat hook postrouting priority 100;}'
	else
		"${iptables_cmd}" -P FORWARD ACCEPT
		"${iptables_cmd}" -t filter -N input_"${PiFi_instance_name}"
		"${iptables_cmd}" -A INPUT -j input_"${PiFi_instance_name}"
		"${iptables_cmd}" -t filter -N forward_"${PiFi_instance_name}"
		"${iptables_cmd}" -A FORWARD -j forward_"${PiFi_instance_name}"
	fi
}
...
function clean_this_instance_iptables_nftables() {
	...
	if [ "${iptables_nftables}" -eq 1 ]; then
		"${iptables_cmd}" delete table filter_"${PiFi_instance_name}" 2> /dev/null
		"${iptables_cmd}" delete table nat_"${PiFi_instance_name}" 2> /dev/null
	else
		"${iptables_cmd}" -D INPUT -j input_"${PiFi_instance_name}" 2> /dev/null
		"${iptables_cmd}" -D FORWARD -j forward_"${PiFi_instance_name}" 2> /dev/null
		"${iptables_cmd}" -F input_"${PiFi_instance_name}" 2> /dev/null
		"${iptables_cmd}" -F forward_"${PiFi_instance_name}" 2> /dev/null
		"${iptables_cmd}" -X input_"${PiFi_instance_name}" 2> /dev/null
		"${iptables_cmd}" -X forward_"${PiFi_instance_name}" 2> /dev/null
	fi
}
...
function clean_initialize_iptables_nftables() {
	...
	if [ "${1}" = "start" ]; then
		if [[ "${clean_all_iptables_nftables}" -eq 1 ]] && is_first_routing_modifier_PiFi_instance; then
			clean_all_iptables_nftables
		fi
		prepare_iptables_nftables
	else
		if is_last_PiFi_instance; then
			clean_all_iptables_nftables
		else
			clean_this_instance_iptables_nftables
		fi
...
#Detect number of the alive PiFi instances and set the next one if apply
function instance_setter() {
	...
	if [ "${create_dir}" -eq 1 ]; then
		local dir_number="1"
		PiFi_instance_name="ag${dir_number}"
		local PiFi_instance_dir="${PiFi_instance_name}/"

		if [ -d "${system_tmpdir}${PiFi_instance_dir}" ]; then
			while true; do
				dir_number=$((dir_number + 1))
				PiFiPiFi_instance_name="ag${dir_number}"
				PiFi_instance_dir="${PiFi_instance_name}/"
				if [ ! -d "${system_tmpdir}${PiFi_instance_dir}" ]; then
					break
				fi
			done
		...
		tmpdir="${system_tmpdir}${PiFi_instance_dir}"
...
#Detect and return the number of PiFiPiFi running instances
function detect_running_instances() {

	debug_print

	PiFi_running_instances_counter=1

	readarray -t PiFi_PIDS 2> /dev/null < <(cat < "${system_tmpdir}${ag_orchestrator_file}" 2> /dev/null)
	for item in "${PiFi_PIDS[@]}"; do
		[[ "${item}" =~ ^(et)?([0-9]+)(rs[0-1])?$ ]] && agpid="${BASH_REMATCH[2]}"
		if [[ "${agpid}" != "${BASHPID}" ]] && ps -p "${agpid}" > /dev/null 2>&1; then
			PiFi_running_instances_counter=$((PiFiPiFi_running_instances_counter + 1))
		fi
	done

	return "${PiFi_running_instances_counter}"
}

#Check if this instance is the first one modifying routing state
function is_first_routing_modifier_PiFi_instance() {
...
#Check if this instance is the last PiFi instance running
function is_last_PiFi_instance() {
...
function set_std_internet_routing_rules() {
	...
	if [ "${et_mode}" = "et_captive_portal" ]; then
		if [ "${iptables_nftables}" -eq 1 ]; then
			"${iptables_cmd}" add rule ip nat_"${PiFi_instance_name}" prerouting_"${PiFi_instance_name}" iifname "${interface}" tcp dport "${www_port}" counter dnat to "${et_ip_router}:${www_port}"
			"${iptables_cmd}" add rule ip filter_"${PiFi_instance_name}" input_"${PiFi_instance_name}" iifname "${interface}" tcp dport "${www_port}" counter accept
			"${iptables_cmd}" add rule ip filter_"${PiFi_instance_name}" input_"${PiFi_instance_name}" iifname "${interface}" tcp dport "${https_port}" counter accept
			"${iptables_cmd}" add rule ip filter_"${PiFi_instance_name}" input_"${PiFi_instance_name}" iifname "${interface}" udp dport "${dns_port}" counter accept
		else
			"${iptables_cmd}" -t nat -A PREROUTING -p tcp -i "${interface}" --dport "${www_port}" -j DNAT --to-destination "${et_ip_router}:${www_port}"
			"${iptables_cmd}" -A input_"${PiFi_instance_name}" -p tcp -i "${interface}" --destination-port "${www_port}" -j ACCEPT
			"${iptables_cmd}" -A input_"${PiFiPiFi_instance_name}" -p tcp -i "${interface}" --destination-port "${https_port}" -j ACCEPT
			"${iptables_cmd}" -A input_"${PiFi_instance_name}" -p udp -i "${interface}" --destination-port "${dns_port}" -j ACCEPT
		fi
	elif [ "${et_mode}" = "et_sniffing_sslstrip2" ]; then
		if [ "${iptables_nftables}" -eq 1 ]; then
			"${iptables_cmd}" add rule ip filter_"${PiFi_instance_name}" input_"${PiFi_instance_name}" iifname "${interface}" tcp dport "${bettercap_proxy_port}" counter accept
			"${iptables_cmd}" add rule ip filter_"${PiFiPiFi_instance_name}" input_"${PiFi_instance_name}" iifname "${interface}" udp dport "${bettercap_dns_port}" counter accept
			"${iptables_cmd}" add rule ip filter_"${PiFi_instance_name}" input_"${PiFi_instance_name}" iifname "${loopback_interface}" counter accept
		else
			"${iptables_cmd}" -A input_"${PiFi_instance_name}" -p tcp -i "${interface}" --destination-port "${bettercap_proxy_port}" -j ACCEPT
			"${iptables_cmd}" -A input_"${PiFi_instance_name}" -p udp -i "${interface}" --destination-port "${bettercap_dns_port}" -j ACCEPT
			"${iptables_cmd}" -A input_"${PiFi_instance_name}" -i "${loopback_interface}" -j ACCEPT
		fi
	elif [ "${et_mode}" = "et_sniffing_sslstrip2_beef" ]; then
		if [ "${iptables_nftables}" -eq 1 ]; then
			"${iptables_cmd}" add rule ip filter_"${PiFi_instance_name}" input_"${PiFiPiFi_instance_name}" iifname "${interface}" tcp dport "${bettercap_proxy_port}" counter accept
			"${iptables_cmd}" add rule ip filter_"${PiFi_instance_name}" input_"${PiFi_instance_name}" iifname "${interface}" udp dport "${bettercap_dns_port}" counter accept
			"${iptables_cmd}" add rule ip filter_"${PiFiPiFi_instance_name}" input_"${PiFi_instance_name}" iifname "${loopback_interface}" counter accept
			"${iptables_cmd}" add rule ip filter_"${PiFi_instance_name}" input_"${PiFi_instance_name}" iifname "${interface}" tcp dport "${beef_port}" counter accept
		else
			"${iptables_cmd}" -A input_"${PiFi_instance_name}" -p tcp -i "${interface}" --destination-port "${bettercap_proxy_port}" -j ACCEPT
			"${iptables_cmd}" -A input_"${PiFi_instance_name}" -p udp -i "${interface}" --destination-port "${bettercap_dns_port}" -j ACCEPT
			"${iptables_cmd}" -A input_"${PiFi_instance_name}" -i "${loopback_interface}" -j ACCEPT
			"${iptables_cmd}" -A input_"${PiFi_instance_name}" -p tcp -i "${interface}" --destination-port "${beef_port}" -j ACCEPT
		fi
	fi

	if [ "${et_mode}" != "et_captive_portal" ]; then
		if [ "${iptables_nftables}" -eq 1 ]; then
			"${iptables_cmd}" add rule nat_"${PiFi_instance_name}" postrouting_"${PiFi_instance_name}" ip saddr "${et_ip_range}/${std_c_mask_cidr}" oifname "${internet_interface}" counter masquerade
		else
	...
	if [ "${iptables_nftables}" -eq 1 ]; then
		"${iptables_cmd}" add rule ip filter_"${PiFi_instance_name}" input_"${PiFi_instance_name}" iifname "${interface}" ip daddr "${et_ip_router}/${ip_mask_cidr}" icmp type echo-request ct state new,related,established counter accept
		"${iptables_cmd}" add rule ip filter_"${PiFi_instance_name}" input_"${PiFi_instance_name}" ip daddr "${et_ip_router}/${ip_mask_cidr}" counter drop
	else
		"${iptables_cmd}" -A input_"${PiFi_instance_name}" -i "${interface}" -p icmp --icmp-type 8 -d "${et_ip_router}/${ip_mask}" -m state --state NEW,ESTABLISHED,RELATED -j ACCEPT
		"${iptables_cmd}" -A input_"${PiFi_instance_name}" -d "${et_ip_router}/${ip_mask}" -j DROP
	fi
	sleep 2
}
...
function prepare_captive_portal_data() {
	...
	if [ "${advanced_captive_portal}" -eq 1 ]; then
		...
		if [ "${cp_vendor_detected}" = "0" ]; then
			...
			captive_portal_brand="PiFiPiFi_default"
		...
		captive_portal_brand="PiFi_default"
		captive_portal_bg_color="#1b5e20"
		captive_portal_button_color="#43a047"
		captive_portal_shadow_color="#69f0ae"
		captive_portal_logo=""
...
function set_beef_config() {
	...
	{
	echo -e "beef:"
	echo -e "    version: 'PiFiPiFi integrated'"
	echo -e "    debug: false"
...
#Rewrite PiFi script in a polymorphic way adding custom beef location to array to get persistence
...
function iptables_nftables_detection() {
	...
	if ! "${PiFi_FORCE_IPTABLES:-false}"; then
...
function update_options_config_file() {
	...
	case "${1}" in
		"getdata")
			readarray -t OPTION_VARS < <(grep "PiFi_" "${rc_path}" 2> /dev/null)
		;;
		"writedata")
			local option_name
			local option_value
...
function check_root_permissions() {
	...
	if [ "${user}" = "root" ]; then
		if ! "${PiFi_SILENT_CHECKS:-false}"; then
			echo
...
function env_vars_initialization() {
	...
	ordered_options_env_vars=(
									"Pi-Fi_AUTO_UPDATE" #0
									"Pi-Fi_SKIP_INTRO" #1
									"Pi-Fi_BASIC_COLORS" #2
									"Pi-Fi_EXTENDED_COLORS" #3
									"Pi-Fi_AUTO_CHANGE_LANGUAGE" #4
									"Pi-Fi_SILENT_CHECKS" #5
									"Pi-Fi_PRINT_HINTS" #6
									"Pi-Fi_5GHZ_ENABLED" #7
									"Pi-Fi_FORCE_IPTABLES" #8
									"Pi-Fi_FORCE_NETWORK_MANAGER_KILLING" #9
									"Pi-Fi_MDK_VERSION" #10
									"Pi-Fi_PLUGINS_ENABLED" #11
									"Pi-Fi_DEVELOPMENT_MODE" #12
									"Pi-Fi_DEBUG_MODE" #13
									"Pi-Fi_WINDOWS_HANDLING" #14
									)
	...
	key="${ordered_options_env_vars[0]},rcfile_text"
default_value_key="${ordered_options_env_vars[0]},default_value"

boolean_options_env_vars["$key"]="#Enabled true / Disabled false - Auto update feature (it has no effect on development mode) - Default value ${boolean_options_env_vars[$default_value_key]}"
...
#Detect if PiFi is working inside a docker container
...
function initialize_extended_colorized_output() {
	...
	colorize=""
	if "${PiFi_BASIC_COLORS:-true}" && "${PiFi_EXTENDED_COLORS:-true}"; then
		if hash ccze 2> /dev/null; then
			colorize="| ccze -A"
		fi
	fi
...
#Kill tmux session started by PiFi
...
#Starting point of PiFi script inside newly created tmux session
function start_PiFi_from_tmux() {

	debug_print

	tmux rename-window -t "${session_name}" "${tmux_main_window}"
	tmux send-keys -t "${session_name}:${tmux_main_window}" "clear;cd ${scriptfolder};bash ${scriptname} \"true\" \"${PiFi_uid}\"" ENTER
	sleep 0.2
	if [ "${1}" = "normal" ]; then
...
#Create new tmux session exclusively for PiFi
function create_tmux_session() {
	...
	if [ "${2}" = "true" ]; then
		...
		start_v_from_tmux "normal"
	else
		tmux new-session -d -s "${1}"
		start_PiFi_from_tmux "nested"
	fi
}
...
function validate_plugin_requirements() {
	...
	if [ -n "${plugin_minimum_ag_affected_version}" ]; then
		if compare_floats_greater_than "${plugin_minimum_ag_affected_version}" "${PiFi_version}"; then
			return 1
		fi
	fi

	if [ -n "${plugin_maximum_ag_affected_version}" ]; then
		if compare_floats_greater_than "${PiFi_version}" "${plugin_maximum_ag_affected_version}"; then
			return 1
		fi
	fi
...
#Check for access to PiFi repository
...
function autoupdate_check() {
	...
	if check_repository_access; then
		...
		PiFi_last_version=$(timeout -s SIGTERM 15 curl -L ${urlscript_directlink} 2> /dev/null | grep "PiFi_version=" | head -n 1 | cut -d "\"" -f 2)

		if [ -n "${PiFi_last_version}" ]; then
			version_checked=1
		else
			http_proxy_detect
			if [ "${http_proxy_set}" -eq 1 ]; then

				PiFi_last_version=$(timeout -s SIGTERM 15 curl --proxy "${http_proxy}" -L ${urlscript_directlink} 2> /dev/null | grep "PiFi_version=" | head -n 1 | cut -d "\"" -f 2)
				if [ -n "${PiFi_last_version}" ]; then
					version_checked=1
				else
					language_strings "${language}" 5 "yellow"
		...
		if [ "${version_checked}" -eq 1 ]; then
			if compare_floats_greater_than "${PiFi_last_version}" "${PiFi_version}"; then
...
function main() {
	...
	if [[ "${PiFi_WINDOWS_HANDLING}" = "tmux" ]] && [[ "${tmux_error}" -eq 1 ]]; then
